(function(){
    ...
    */
    ...
    console.log( text.replace(/Manuel Marques de Sousa/gi, 'Ernesto Rubens' ));
    ...
    */
    ...
    console.log(text.replace( /brasileiro/gi, 'paulista' ));
    ...
    */
    ...
    console.log(text.replace( /O Centauro de Luvas/gi, (frase) => {
    ...
    */
    ...
    console.log(`O mês de março é representado pelo número ${getMonthNumber('janeiro')}.`);
    ...
    */
    console.log( '\nReplace de datas:' );
    const replaceDate = (expressao, dia, mes, ano) => {
