...
*/
let pessoa = {nome: 'Ernesto', sobrenome: 'Rubens', sexo: 'Masculino', idade: 21, altura: 1.75, peso: 70, andando: false, caminhouQuantosMetros: 0};
...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Ernesto Rubens!'
