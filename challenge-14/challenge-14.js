(function(){
    ...
    */
    console.log( '\nOperation:' );
    let operation = justMod2Or3.reduce(function(acumulador, atual){
    ...
    */
    console.log( '\nOperation 2:' );
    operation2 = justMod2Or3.reduceRight(function(acumulado, atual){
    ...
    */
    ...
    let name = ['Er', 'nes', 'to'];
    let linguaP = name.reduce(function(acumulador, atual){
    ...
    */
    ...
    Array.isArray(justMod2Or3) ? console.log(justMod2Or3.join('')) : '';
})();